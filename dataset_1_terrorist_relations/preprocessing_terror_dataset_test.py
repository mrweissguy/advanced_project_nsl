...
# changes made by Johan Weiss (s182969) to fit Terrorist Relations
...
flags.DEFINE_string(
    ...
    """Input file for terror content that contains ID, words and labels.""")
flags.DEFINE_string('input_graph', '/tmp/CustomTerroristRel/TerroristRel.edges',
                    """Input file for terror citation graph in TSV format.""")
...
flags.DEFINE_string('output_test_data', '/tmp/CustomTerroristRel/test_examples.tfr',
...
def main(unused_argv):
  ...
  # Parses terror content into TF Examples.
