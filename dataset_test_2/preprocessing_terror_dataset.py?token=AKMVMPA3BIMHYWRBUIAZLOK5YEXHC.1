...
flags.DEFINE_string(
    'input_cora_content', '/tmp/TerrorAttack/terrorist_attack.node',
    """Input file for Cora content that contains ID, words and labels.""")
flags.DEFINE_string('input_cora_graph', '/tmp/TerrorAttack/terrorist_attack_loc_org.edges',
...
flags.DEFINE_string('output_test_data', '/tmp/TerrorAttack/test_examples.tfr',
...
def parse_cora_content(in_file, train_percentage):
  ...
  label_index = {
      # 'contact': 0,
      # 'non-contact': 1,
    'http://counterterror.mindswap.org/2005/terrorism.owl#Arson':0,
	...
	'http://counterterror.mindswap.org/2005/terrorism.owl#Weapon_Attack':5,
      ...
      # 'http://profilesinterror.mindswap.org/document/4#Ramzi_Yousef_http://profilesinterror.mindswap.org/document/19#Nidal_Ayyad': 2,
      # 'http://profilesinterror.mindswap.org/document/19#EyadIsmoil_http://profilesinterror.mindswap.org/document/19#Nidal_Ayyad': 3,
      # 'http://profilesinterror.mindswap.org/document/19#AhmadAjaj_http://profilesinterror.mindswap.org/document/19#Nidal_Ayyad': 4,
      # 'http://profilesinterror.mindswap.org/document/19#MohammedSalameh_http://profilesinterror.mindswap.org/document/19#Nidal_Ayyad': 5,
      # 'http://profilesinterror.mindswap.org/document/27#FarouqQaddoumi_http://profilesinterror.mindswap.org/document/2005/05/24/18:26:22#Khaled_al-Fahoum': 6,
      # 'No':7,
  }
  ...
  with open(in_file, 'rU') as cora_content:
    for line in cora_content:
      ...
      features = {
          ...
          # 'words': tf.FixedLenFeature([3], tf.int64),
          # 'label': _int64_feature(label_index[entries[-1]]),
