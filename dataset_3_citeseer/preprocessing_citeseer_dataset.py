...
# changes made by Johan Weiss (s182969) to fit the CiteSeer dataset with scientifi publications.
...
flags.DEFINE_string(
    ...
    """Input file for citeseer content that contains ID, words and labels.""")
flags.DEFINE_string('input_graph', '/tmp/citeseer/citeseer.cites',
                    """Input file for citeseer citation graph in TSV format.""")
...
flags.DEFINE_string('output_test_data', '/tmp/citeseer/test_examples.tfr',
...
def main(unused_argv):
  ...
  # Parses citeseer content into TF Examples.
